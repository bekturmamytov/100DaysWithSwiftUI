...
let tempetureInCelcius = 23
let tempInFahrenheit = ((tempetureInCelcius * 9) / 5) + 32
print("Temperature in Celsius is \(tempetureInCelcius)°")
print("Temperature in Fahrenheit is \(tempInFahrenheit)°")
